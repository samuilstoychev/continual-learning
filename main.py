...
def run(args, verbose=False):
    ...
    start = time.time()
    # Train model
    # NOTE: Here is where we integrate the model (the Classifier) with the generator. We pass it as an argument. 
    train_cl(
    ...
    # NOTE: We are evaluating precision (and not accuracy)? 
    # NOTE: `args.tasks` is the *number* of tasks (specified in the arguments). 
